...
/**
 * jvm (test harness) actual. Kept textually identical to
 * LocaleFormatters.android.kt — change both together. The jvm target is a
 * main compilation, so this actual is required for `:shared:assemble` even
 * though only jvmTest ever runs it.
 */
